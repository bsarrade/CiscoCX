...
$PTversion = (Get-Module -Name Cisco.UCSCentral).Version
...
$DiskList | select UcsCentral,Dn,SKU,Vendor,Model,Serial,DeviceVersion | Export-Csv -NoTypeInformation $fullfile
$RiskList | select UcsCentral,Dn,SKU,Vendor,Model,Serial,DeviceVersion | Export-Csv -NoTypeInformation $riskfile
